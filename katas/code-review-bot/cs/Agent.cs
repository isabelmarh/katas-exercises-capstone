...
{
    // Note that the examples in this file use Dapper ORM syntax
    // Dapper is a simple object relational mapper (ORM).
    // More information can be found here: https://github.com/DapperLib/Dapper

    private const string AgentInstructions = """

        You are an experienced code reviewer. Analyze the code provided and offer constructive 
        review feedback. Focus on identifying issues and providing actionable suggestions.
        ...
        string evaluationSuccessMeans)
    {
        ...
        var agent = chatClient.CreateAIAgent(instructions: AgentInstructions);
