...
def generate_html_report(assessment: CapstoneAssessment, project_name: str) -> str:
    ...
    categories = [
        ...
        ("Evaluation & Metrics", assessment.evaluation),
        ("Code Quality & Engineering", assessment.code_quality),
...
<head>
    ...
    <title>Capstone Assessment - {project_name}</title>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .insight-box.improvements li::before {{
            background: #F7B500;
        }}
...
<body>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 408.81 65.49">
                    ...
                    <g>
                        <g>
                            ...
                            <path class="cls-2" d="M241.93,46.84a4.35,4.35,0,0,1-3-.74,4.35,4.35,0,0,1-.74-3V27.27h4.91l3-5.89h-7.9v-9.6h-8.8v9.6H225l-3,5.88h7.39V46.16a8.13,8.13,0,0,0,.81,3.9,5.74,5.74,0,0,0,2.2,2.3,9.27,9.27,0,0,0,3.22,1.08,25.16,25.16,0,0,0,3.87.28c.87,0,1.75,0,2.66-.06a21.4,21.4,0,0,0,2.48-.25V46.59a10.42,10.42,0,0,1-1.3.19C242.9,46.82,242.43,46.84,241.93,46.84Z"/>
                            <path class="cls-2" d="M52.27,46.84a4.36,4.36,0,0,1-3-.74,4.35,4.35,0,0,1-.74-3V27.27h4.53l3-5.89H48.55v-9.6H39.76v9.6H35.35l-3,5.88h7.4V46.16a8.14,8.14,0,0,0,.8,3.9,5.81,5.81,0,0,0,2.2,2.3A9.34,9.34,0,0,0,46,53.44a25.16,25.16,0,0,0,3.87.28c.87,0,1.76,0,2.66-.06A21.4,21.4,0,0,0,55,53.41V46.59a10.42,10.42,0,0,1-1.3.19C53.24,46.82,52.76,46.84,52.27,46.84Z"/>
                            <path class="cls-2" d="M343.07,20.52c-7.39,0-10.22,6.81-10.22,6.81h-.12V21.38h-8.36v32h8.79V40h0c0-7.8,1.52-11.28,8.17-11.28a7.19,7.19,0,0,1,3.44.82l3.77-7.4A9.88,9.88,0,0,0,343.07,20.52Z"/>
                            <polygon class="cls-2" points="281.9 21.39 276.01 43.06 275.89 43.06 270.44 21.39 261.89 21.39 256.56 43.13 256.44 43.13 250.56 21.39 244.83 32.62 251.43 53.41 260.53 53.41 265.98 31.91 266.1 31.91 271.8 53.41 280.85 53.41 290.94 21.39 281.9 21.39"/>
                        </g>
                    </g>
                </svg>
            </div>
            <h1>{project_name}</h1>
            <p>AI Engineering Upskilling Program - Capstone Assessment</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="score-section">
            <div class="score-details">
                <div class="overall-rating">{overall_rating_text}</div>
    ...
    <div class="footer">
        Generated by <span class="tw-brand">Thoughtworks</span> Capstone Assessor • AI Engineering Upskilling Program
    </div>
</body>
</html>
"""
...
def generate_agent_kata_report(
    assessment: AgentKataAssessment, project_name: str
) -> str:
    """Simplified HTML report for single-file Pydantic AI agent katas."""
    ...
    missing_html = (
        "\n".join([f"<li>{m}</li>" for m in assessment.missing_elements])
        if assessment.missing_elements
        else "<li>No major missing pieces detected. Consider optional improvements above.</li>"
    )
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Agent Kata Assessment - {project_name}</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .box.improvements li::before {{
            background: #F7B500;
        }}
        .box.missing li::before {{
            background: #F2617A;
        }}
        .footer {{
            background: #003d4f;
...
<body>
    <div class="header">
        <div class="header-content">
            <h1>Agent Katas</h1>
            <p>Pydantic AI Agent Kata Assessment - {project_name}</p>
        </div>
    </div>
    <div class="container">
        <div class="section">
        ...
        <div class="section">
            <h2>Pydantic AI Usage</h2>
            <p>{assessment.pydantic_ai_usage}</p>
        </div>
        <div class="section">
            <div class="insights-grid">
        ...
        <div class="section">
            <div class="box missing">
                <h3>Missing or Optional Enhancements</h3>
                <ul>{missing_html}</ul>
            </div>
        </div>
    </div>
    <div class="footer">
        Generated by <span class="tw-brand">Thoughtworks</span> Capstone Assessor • Pydantic AI Agent Katas
    </div>
</body>
</html>
"""
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>MCP Kata Assessment - {project_name}</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <style>
...
<body>
    <div class="header">
        <div class="header-content">
            <h1>MCP Katas</h1>
            <p>MCP Server Kata Assessment - {project_name}</p>
        </div>
    </div>
    <div class="container">
        <div class="section">
        ...
        <div class="section">
            <h2>MCP/FastMCP Usage</h2>
            <p>{assessment.mcp_server_usage}</p>
        </div>
        <div class="section">
            <div class="insights-grid">
                <div class="box strengths">
    ...
    <div class="footer">
        Generated by <span class="tw-brand">Thoughtworks</span> Capstone Assessor • MCP Server Katas
    </div>
</body>
</html>
"""
